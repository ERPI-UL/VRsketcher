...
var tools : Dictionary = {
	...
	"TOOL_PEN"				: {
		...
		"options_menu"	: load("res://scenes/sketch_tools/pen/pen_options_menu.tscn").instance(),
	},
	"TOOL_ERASER"			: {
		"name"			: "Effacer",
...
func get_tool_options_menu(tool_name : String) -> Control :
	if tools.has(tool_name) == true :
		return tools[tool_name]["options_menu"] as Control;
	return null;
